        ...
        <div className="lg:p-8 relative z-50   md:p-8 pt-7 p-0 flex flex-col justify-center items-center w-full">
          ...
          <div className="w-full overflow-y-auto ">
            ...
            <CardDescription className="text-pretty mb-9 text-black/70 text-md lg:text-left text-center">
              Tu cuenta está a un paso de ser recuperada. Por favor, crea una
              nueva contraseña que sea segura y fácil de recordar para ti.
              Asegúrate de que tu contraseña tenga al menos 6 caracteres,
              incluya una combinación de letras mayúsculas, minúsculas, números
              o símbolos.
            </CardDescription>
