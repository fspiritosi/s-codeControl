    ...
    <Sheet>
      ...
      <SheetContent className="border-l-4 border-l-muted">
        <SheetHeader>
          ...
          <SheetDescription>
            Puedes editar el tipo de documento seleccionado, los documentos
            creados por defecto no son editables
          </SheetDescription>
        </SheetHeader>
              ...
              <SheetFooter className="flex  gap-11 flex-wrap">
                <AlertDialog>
                  ...
                  <AlertDialogContent>
                    <AlertDialogHeader>
                      <AlertDialogTitle>
                        Estas seguro que deseas eliminar el tipo de documento{' '}
                        {Equipo.name}?
                      </AlertDialogTitle>
                      <AlertDialogDescription>
                        Esta accion no puede revertirse, y eliminara todos los
