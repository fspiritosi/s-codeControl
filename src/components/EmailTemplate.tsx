  ...
  <div>
    ...
    <html lang="es">
      ...
      <body style={{ backgroundColor: '#f3f3f5', fontFamily: 'HelveticaNeue, Helvetica, Arial, sans-serif' }}>
        <table align="center" width="100%" border={0} cellPadding="0" cellSpacing="0"  style={{ maxWidth: '100%', width: '680px', margin: '0 auto', backgroundColor: '#ffffff' }}>
          <tbody>
            <tr style={{ width: "100%" }}>
              <td>
                <table
                          ...
                          <tbody style={{ width: "100%" }}>
                            <tr style={{ width: "100%" }}>
                              <td style={{ padding: '20px 30px 15px' }}>
                                <h1 style={{ color: '#fff', fontSize: '27px', fontWeight: 'bold', lineHeight: '27px' }}>
                                  Codecontrol.com.ar
                                </h1>
                              ...
                              <td style={{ padding: '30px 10px' }}>
                                <img
                                  ...
                                  style={{ display: 'block', outline: 'none', border: 'none', textDecoration: 'none', maxWidth: '100%' }}
                                  width="140"
                                />
                              </td>
                            </tr>
                ...
                <table align="center" width="100%" border={0} cellPadding="0" cellSpacing="0"  style={{ padding: '30px 30px 40px 30px' }}>
                  <tbody>
                    <tr>
                      <td>
                        ...
                        <ul>
                          ...
                          <p style={{ fontSize: '15px', lineHeight: '21px', margin: '16px 0', color: '#3c3f44' }}>Motivo: {reason}.</p>
