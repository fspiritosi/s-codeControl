...
import { Documents, DocumentsTable } from '@/shared/types/types';
import { storage, type StorageBucket } from '@/shared/lib/storage';
import { useEdgeFunctions } from './useEdgeFunctions';
import { fetchDocumentEmployeesForCompany, fetchDocumentEquipmentForCompany } from '@/modules/documents/features/list/actions.server';
import { updateDocumentById } from '@/modules/documents/features/manage/actions.server';
import { insertSingleDocumentEmployee, insertSingleDocumentEquipment } from '@/modules/documents/features/upload/actions.server';
import { fetchAllDocumentTypes, fetchDocumentEmployeesByDocNumber, fetchEquipmentDocsByVehicleId } from '@/modules/documents/features/list/actions.server';
