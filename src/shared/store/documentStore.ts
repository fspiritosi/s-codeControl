import { VehiclesAPI } from '@/shared/types/types';
...
import { fetchAllDocumentsEmployeesByCompany, fetchAllDocumentsEquipmentByCompany } from '@/modules/documents/features/list/actions.server';
