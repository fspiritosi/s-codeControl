    ...
    if (existingDoc && !fetchError) {
      ...
      try {
        ...
        const updateData = {
          ...
          expiry_date: formData.get('expiry_date') as string || existingDoc.expiry_date || null,
          description: formData.get('description') as string || existingDoc.description || null
        };
