...
import { RepairsSolicituds, TypeOfRepair } from '@/shared/types/types';
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-gray-100 p-2">
      <Card className="w-full max-w-md space-y-6 rounded-xl bg-white p-6 py-0 shadow-lg">
        ...
        <CardTitle className="text-center text-3xl font-bold text-gray-900 mt-0">Seleccione una opcion</CardTitle>
