        ...
        <DialogContent className="max-w-[90vw] w-full max-h-[90vh] overflow-y-auto rounded-lg">
          ...
          <Tabs defaultValue="vehicle" className="w-full">
            <TabsList className="grid w-full grid-cols-2">
              <TabsTrigger value="vehicle">Vehiculo</TabsTrigger>
              <TabsTrigger value="repair">Reparacion</TabsTrigger>
            </TabsList>
            ...
            <TabsContent value="repair">
              <div className="grid gap-4 py-4">
                ...
                <div className="grid grid-cols-2 items-center gap-4">
                  <span className="font-bold">Descripcion del mecanico:</span>
                ...
                {selectedRequest?.user_images?.length && selectedRequest?.user_images?.length > 0 && (
                  <div>
                    <span className="font-bold">Imagenes del usuario:</span>
                ...
                {selectedRequest?.mechanic_images?.length && selectedRequest?.mechanic_images?.length > 0 && (
                  <div>
                    <span className="font-bold">Imagenes del mecanico:</span>
                    <div className="flex flex-wrap gap-2 mt-2">
