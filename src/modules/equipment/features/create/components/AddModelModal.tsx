...
import { insertModelVehicle } from '@/modules/equipment/features/create/actions.server';
import { generic } from '@/modules/equipment/shared/types';
...
export default function AddModelModal({
  ...
  return (
    <AlertDialog>
      ...
      <AlertDialogContent>
        <AlertDialogHeader>
          <AlertDialogTitle>Agregar un nuevo modelo de un vehiculo</AlertDialogTitle>
          <AlertDialogDescription>
            Por favor complete los siguientes campos para agregar un nuevo modelo de vehiculo.
          </AlertDialogDescription>
        </AlertDialogHeader>
        <AlertDialogFooter>
