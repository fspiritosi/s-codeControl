import { Customers, Employee, Equipment, Items, Services } from '@/modules/operations/features/daily-reports/components/types';
import {
  getCustomerName,
  getEmployeeNames,
  getEquipmentNames,
  getItemName,
  getServiceName,
} from '@/modules/operations/features/daily-reports/components/utils/utils';
