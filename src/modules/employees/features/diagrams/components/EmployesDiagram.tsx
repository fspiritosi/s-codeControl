import { fetchDiagrams, fetchDiagramsTypes } from '@/modules/employees/features/diagrams/actions.server';
import { fetchAllActivesEmployees } from '@/modules/employees/features/list/actions.server';
