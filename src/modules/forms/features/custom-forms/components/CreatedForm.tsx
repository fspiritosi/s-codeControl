...
import { Table, TableBody, TableCaption, TableCell, TableHeader, TableRow } from '@/shared/components/ui/table';
import { fetchCustomFormsByCompany } from '@/modules/forms/features/custom-forms/actions.server';
import { fetchFormAnswersByFormId } from '@/modules/forms/features/answers/actions.server';
import { Campo } from '@/shared/types/types';
