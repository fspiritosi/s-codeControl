...
import { createCustomForm } from '@/modules/forms/features/custom-forms/actions.server';
import { COMPANIES_TABLE, DOCUMENTS_TABLE, EMPLOYEES_TABLE, VEHICLES_TABLE } from '@/shared/lib/utils/utils';
import { useCountriesStore } from '@/shared/store/countries';
import { useLoggedUserStore } from '@/shared/store/loggedUser';
import { Campo, FormField, types } from '@/shared/types/types';
import { useRouter } from 'next/navigation';
import { Dispatch, SetStateAction, useCallback, useState } from 'react';
import { toast } from 'sonner';
import FieldRenderer from '@/modules/forms/features/custom-forms/components/formUtils/fieldRenderer';
import { buildFormData } from '@/modules/forms/features/custom-forms/components/formUtils/formUtils';
