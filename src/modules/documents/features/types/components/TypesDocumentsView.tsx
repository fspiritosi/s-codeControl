...
import DocumentsTable from '@/modules/documents/features/list/components/DocumentsTable'; // Asumo que este componente existe
import FilterHeader from '@/modules/documents/features/list/components/FilterComponent';
import { Checkbox } from '@/shared/components/ui/checkbox';
import { fetchDocumentTypesByCompanyIncludingInactive } from '@/modules/documents/features/list/actions.server';
import { updateDocumentTypeActive } from '@/modules/documents/features/types/actions.server';
