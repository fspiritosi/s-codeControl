...
import { EquipmentDocumentRowActions } from './EquipmentDocumentRowActions';
...
export const permanentEquipmentDocColumns: ColumnDef<any>[] = [
  {
    id: 'actions',
    meta: { excludeFromExport: true },
    cell: ({ row }) => <EquipmentDocumentRowActions row={row} />,
    enableHiding: false,
  },
  {
    accessorKey: 'resource',
    meta: { title: 'Equipo (Dominio)' },
  ...
  },
  {
    ...
    cell: ({ row }) => {
      ...
      if (!value) return <Badge variant="outline">Sin tipo</Badge>;
...
export const monthlyEquipmentDocColumns: ColumnDef<any>[] = [
  {
    id: 'actions',
    meta: { excludeFromExport: true },
    cell: ({ row }) => <EquipmentDocumentRowActions row={row} />,
