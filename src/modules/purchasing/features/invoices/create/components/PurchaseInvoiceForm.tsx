          ...
          <CardContent className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <FormField control={form.control} name="voucher_type" render={({ field }) => (
              <FormItem>
                ...
                <Select onValueChange={field.onChange} value={field.value}>
                  ...
                  <SelectContent>
                    {Object.entries(VOUCHER_TYPE_LABELS).map(([v, l]) => <SelectItem key={v} value={v}>{l}</SelectItem>)}
                  </SelectContent>
                </Select>
                <FormMessage />
              </FormItem>
            ...
            <FormField control={form.control} name="point_of_sale" render={({ field }) => (
              <FormItem>
                ...
                <FormControl><Input placeholder="0001" maxLength={5} {...field} /></FormControl>
                <FormMessage />
              </FormItem>
            )} />
            <FormField control={form.control} name="number" render={({ field }) => (
              <FormItem>
                ...
                <FormControl><Input placeholder="00000001" {...field} /></FormControl>
                <FormMessage />
              </FormItem>
            )} />
            ...
            <FormField control={form.control} name="cae" render={({ field }) => (
              <FormItem>
                ...
                <FormControl><Input placeholder="CAE" {...field} /></FormControl>
                <FormMessage />
              </FormItem>
            )} />
          </CardContent>
