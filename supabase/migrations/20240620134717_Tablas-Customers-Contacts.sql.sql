revoke delete on table "public"."hired_modules" from "anon";

revoke insert on table "public"."hired_modules" from "anon";

revoke references on table "public"."hired_modules" from "anon";

revoke select on table "public"."hired_modules" from "anon";

revoke trigger on table "public"."hired_modules" from "anon";

revoke truncate on table "public"."hired_modules" from "anon";

revoke update on table "public"."hired_modules" from "anon";

revoke delete on table "public"."hired_modules" from "authenticated";

revoke insert on table "public"."hired_modules" from "authenticated";

revoke references on table "public"."hired_modules" from "authenticated";

revoke select on table "public"."hired_modules" from "authenticated";

revoke trigger on table "public"."hired_modules" from "authenticated";

revoke truncate on table "public"."hired_modules" from "authenticated";

revoke update on table "public"."hired_modules" from "authenticated";

revoke delete on table "public"."hired_modules" from "service_role";

revoke insert on table "public"."hired_modules" from "service_role";

revoke references on table "public"."hired_modules" from "service_role";

revoke select on table "public"."hired_modules" from "service_role";

revoke trigger on table "public"."hired_modules" from "service_role";

revoke truncate on table "public"."hired_modules" from "service_role";

revoke update on table "public"."hired_modules" from "service_role";
...
revoke select on table "public"."modules" from "authenticated";
...
revoke select on table "public"."modules" from "service_role";
...
alter table "public"."hired_modules" drop constraint "hired_modules_company_id_fkey";

alter table "public"."hired_modules" drop constraint "hired_modules_module_id_fkey";

drop function if exists "public"."delete_expired_subscriptions"();

alter table "public"."hired_modules" drop constraint "hired_modules_pkey";

alter table "public"."modules" drop constraint "modules_pkey";

drop index if exists "public"."hired_modules_pkey";

drop index if exists "public"."modules_pkey";

drop table "public"."hired_modules";
