...
alter table "public"."company" add constraint "company_owner_id_fkey" FOREIGN KEY (owner_id) REFERENCES profile(id) not valid;
...
alter table "public"."vehicles" add constraint "public_vehicles_user_id_fkey" FOREIGN KEY (user_id) REFERENCES profile(id) not valid;

alter table "public"."vehicles" validate constraint "public_vehicles_user_id_fkey";
